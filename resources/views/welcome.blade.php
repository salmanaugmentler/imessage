                    ...
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Message <code class="badge bg-info text-white">https://imessage-augmentler.herokuapp.com/</code>
                            </button>
                        </h5>
                    </div>
                    ...
                    <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne">
                                User <code class="badge bg-info text-white">https://imessage-augmentler.herokuapp.com/</code>
                            </button>
                        </h5>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="card-body">
                            <code class="bg-dark text-white badge p-2 text-left d-block mb-1">Not written yet</code>
                        </div>
                    </div>
                </div>
            </div>
